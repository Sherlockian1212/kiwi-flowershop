...
?>
    ...
    <div class="login">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="group">
                <input type="text" id="admin_name" class="form-control" required="required" name="admin_name" placeholder="Enter name">
            </div>
            <div class="group">
                <input type="password" id="admin_password" class="form-control" required="required" name="admin_password" placeholder="Password">
                <span id="showPassword">
			</span>
            </div>
            <div class="recovery">
                <p>Đăng ký tài khoản<a style="text-decoration-line: underline" href="admin_registration.php">tại đây</a></p>
            </div>
            <div class="signIn">
